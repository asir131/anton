...
export function CompetitionDetails() {
  ...
  // Every 100 points = £1 discount (or equivalent currency)
  const pointsDiscount = usePoints ? availablePoints / 100 : 0;
  ...
  const handleAddToCart = async () => {
    ...
    try {
      await addToCart({
        ...
        quantity,
        points_to_redeem: usePoints ? availablePoints : 0,
      }).unwrap();
      toast.success(
        `Added to cart. Total with discount: £${total.toFixed(2)}`
      );
    } catch (err: any) {
              ...
              <div className="card-premium p-6">
                ...
                <div className="space-y-3">
                  ...
                  <motion.button
                    ...
                    disabled={selectedAnswer !== correctAnswer || isAddingToCart}
                    ...
                    whileHover={
                      selectedAnswer === correctAnswer && !isAddingToCart
                        ? { scale: 1.02 }
                        : {}
                    }
                    whileTap={
