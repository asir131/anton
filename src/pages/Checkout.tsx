...
import { useCreateCheckoutIntentMutation } from "../store/api/cartApi";
export function Checkout() {
  ...
  const handleComplete = () => {
    ...
    createCheckoutIntent({ points_to_redeem })
      .unwrap()
      .then(() => {
                    ...
                    <label
                      ...
                      className={`flex items-center p-4 rounded-xl cursor-pointer transition-colors ${
                        paymentMethod === method.id
                          ...
                          : "bg-gradient-end border-2 border-transparent hover:bg-gray-800"
                      }`}
                    >
                      <input
                        type="radio"
